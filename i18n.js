...
(function () {
  ...
  var INDEX = {
    ...
    text: [
      ...
      ["#operations .op-card[data-i=\"1\"] .op-card-head", "<span>OBJ 01 · CPA-MS</span><span>Completed ✓</span>"],
      ...
      ["#operations .op-card[data-i=\"1\"] .op-cta", "View the operation <span aria-hidden=\"true\">→</span>"],
      ["#operations .ops-tab:nth-of-type(1) .ops-tab-name", "Moshe Stern"],
      ["#operations .ops-pin:nth-of-type(1) span", "OBJ 01"],
      ["#operations .op-card[data-i=\"2\"] .op-card-head", "<span>OBJ 02 · AHUVIT</span><span>Completed ✓</span>"],
      ...
      ["#operations .op-card[data-i=\"2\"] .op-cta", "View the operation <span aria-hidden=\"true\">→</span>"],
      ["#operations .ops-tab:nth-of-type(2) .ops-tab-name", "Ahuvit Mor"],
      ["#operations .ops-pin:nth-of-type(2) span", "OBJ 02"],
      ["#operations .op-card[data-i=\"3\"] .op-card-head", "<span>OBJ 03 · CODE92</span><span>Completed ✓</span>"],
      ["#operations .op-card[data-i=\"3\"] .op-type", "Business Website"],
      ["#operations .op-card[data-i=\"3\"] .op-client", "Code92"],
      ["#operations .op-card[data-i=\"3\"] .op-desc", "A website for an agency that builds sites, apps and AI automation: a short questionnaire that points every visitor to the right solution, and a full accessibility toolbar."],
      ["#operations .op-card[data-i=\"3\"] .op-cta", "View the operation <span aria-hidden=\"true\">→</span>"],
      ["#operations .ops-tab:nth-of-type(3) .ops-tab-name", "Code92"],
      ["#operations .ops-pin:nth-of-type(3) span", "OBJ 03"],
      ["#operations .op-card[data-i=\"4\"] .op-card-head", "<span>OBJ 04 · ARMY</span><span>Completed ✓</span>"],
      ["#operations .op-card[data-i=\"4\"] .op-type", "Landing Page"],
      ["#operations .op-card[data-i=\"4\"] .op-client", "Army Website, a Scroll Film"],
      ["#operations .op-card[data-i=\"4\"] .op-desc", "A cinematic landing page: a seven-scene war film that plays as you scroll, with a headline landing on every scene."],
      ["#operations .op-card[data-i=\"4\"] .op-cta", "View the operation <span aria-hidden=\"true\">→</span>"],
      ["#operations .ops-tab:nth-of-type(4) .ops-tab-name", "Army Website"],
      ["#operations .ops-pin:nth-of-type(4) span", "OBJ 04"],
      ["#operations .op-card[data-i=\"5\"] .op-card-head", "<span>OBJ 05 · ELYOTAM-IO</span><span>Completed ✓</span>"],
      ["#operations .op-card[data-i=\"5\"] .op-type", "Business Website"],
      ["#operations .op-card[data-i=\"5\"] .op-client", "Elyotam Cohen, Portfolio"],
      ["#operations .op-card[data-i=\"5\"] .op-desc", "A personal portfolio site in English: a bento-grid home page, a projects page linking to each one, and contact straight to WhatsApp."],
      ["#operations .op-card[data-i=\"5\"] .op-cta", "View the operation <span aria-hidden=\"true\">→</span>"],
      ["#operations .ops-tab:nth-of-type(5) .ops-tab-name", "Elyotam Cohen"],
      ["#operations .ops-pin:nth-of-type(5) span", "OBJ 05"],
      ["#operations .ops-index-title", "Objective Index"],
      ["#operations .ops-stamp", "<b>05/05</b><i>objectives</i>"],
      ["#operations .hud-tl", "<b>OPERATION ELYOTAM</b><span>Operations map · Sheet 36R</span><span class=\"hud-coord\" id=\"ops-coord\">31.7683N 35.2137E</span>"],
      ["#operations .hud-tr", "<span class=\"hud-live\">Live</span><span id=\"ops-count\">OBJ 01 / 05</span><span id=\"ops-status\">Status: en route</span>"],
      ["#operations .hud-bl", "<span class=\"hud-scale\"><i></i><i></i><i></i><i></i></span><span>0 · 1 KM · 2 KM</span>"],
  ...
  var JS = {
    ...
    "skip.files": "Skip the map",
    "map.count": "OBJ %N / 05",
    "map.load": "Status: satellite feed",
