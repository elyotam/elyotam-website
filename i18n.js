...
(function () {
  ...
  var INDEX = {
    ...
    text: [
      ...
      [".hero-offer .btn-ghost", "See completed operations"],
      ...
      // 02 · operations file
      ["#operations .section-index", "Operations File"],
      ["#operations .h-mega", "Completed Operations."],
      ["#operations .house-head-note", "Real projects, live in the field. Pick an objective on the map, the file opens and the link goes straight to the live site."],
      ...
      ["#operations .op-card[data-i=\"1\"] .op-cta", "View the operation"],
      ...
      ["#operations .op-card[data-i=\"2\"] .op-cta", "View the operation"],
      ...
      ["#footer .footer-links a:nth-child(2)", "Operations File"],
